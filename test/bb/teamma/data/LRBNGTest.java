    ...
    public void testGetSkill() {
        ...
        for (int i = 0; i < instance.getSkillTypeCount(); i++) {
            ...
            for (int j = 0; j < sp.getSkillCount(); j++) {
                ...
                Skill sk2 = instance.getSkill(sk.getName(), false);
                assertEquals(sk, sk2);

                Skill sk3 = instance.getSkill(Translate.translate(sk.getName()), true);
                assertEquals(sk, sk3);
...
//        String name = "";
    ...
    /**
     * Test of isCheckNbBigGuys method, of class LRB.
     */
    @Test
    ...
    /**
     * Test of setCheckNbBigGuys method, of class LRB.
     */
    @Test

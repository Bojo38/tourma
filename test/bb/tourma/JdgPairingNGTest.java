 ...
 * @author WFMJ7631
 */
public class JdgPairingNGTest {
    
    private DialogFixture window;
    JdgPairing jdg;
    private static Robot robot;
    Round  round;
    public JdgPairingNGTest() {
    }
    ...
    public void setUpMethod() throws Exception {
        ...
        jdg = new JdgPairing(null,false,Tournament.getTournament().getTeam(0),
        Tournament.getTournament().getTeam(1),round,new TeamMatch(round));

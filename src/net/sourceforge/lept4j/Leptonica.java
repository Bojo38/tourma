...
//    int bbufferWriteStream(L_ByteBuffer bb, FILE fp, NativeSize nbytes, NativeSizeByReference pnout);
     ...
     */
    Pixa pixaGenerateFontFromFile(String dir, int fontsize, IntBuffer pbl0, IntBuffer pbl1, IntBuffer pbl2);
     ...
     */
    Pixa pixaGenerateFontFromString(int fontsize, IntBuffer pbl0, IntBuffer pbl1, IntBuffer pbl2);
     ...
     */
    Pixa pixaGenerateFont(Pix pixs, int fontsize, IntBuffer pbl0, IntBuffer pbl1, IntBuffer pbl2);
...
//    int pixWriteStreamBmp(FILE fp, Pix pix);
    ...
    /**
     * Original signature : <code>void* l_bootnum_gen1()</code><br>
     * <i>native declaration : allheaders.h:304</i>
     */
    Pointer l_bootnum_gen1();

    /**
     * Original signature : <code>void* l_bootnum_gen2()</code><br>
     * <i>native declaration : allheaders.h:306</i>
     */
    Pointer l_bootnum_gen2();
...
//    int dewarpaWriteStream(FILE fp, L_Dewarpa dewa);
    ...
    /**
     * Original signature :
     * <code>l_int32 dewarpSinglePageInit(PIX*, l_int32, l_int32, l_int32, PIX**, L_DEWARPA**)</code><br>
     * <i>native declaration : allheaders.h:1212</i>
     */
    int dewarpSinglePageInit(Pix pixs, int thresh, int adaptive, int use_both, PointerByReference ppixb, PointerByReference pdewa);
...
//    int kernelWriteStream(FILE fp, L_Kernel kel);
    ...
    /**
     * Original signature :
     * <code>PIXA* pixaExtendIterative(PIXA*, l_int32, l_int32, SEL*, l_int32)</code><br>
     * <i>native declaration : allheaders.h:2196</i>
     */
    Pixa pixaExtendIterative(Pixa pixas, int type, int niters, Pointer sel, int include);
...
//    Numa numaaFlattenToNuma(Numaa naa);
     ...
     */
    Numa numaUnionByAset(Numa na1, Numa na2);

    /**
     * Original signature : <code>NUMA* numaRemoveDupsByAset(NUMA*)</code><br>
    ...
    /**
     * Original signature :
     * <code>NUMA* numaIntersectionByAset(NUMA*, NUMA*)</code><br>
     * <i>native declaration : allheaders.h:2468</i>
     */
    Numa numaIntersectionByAset(Numa na1, Numa na2);

    /**
     * Original signature : <code>L_ASET* l_asetCreateFromNuma(NUMA*)</code><br>
...
//    int numaEvalHaarSum(Numa nas, float width, float shift, float relweight, FloatBuffer pscore);
    ...
    /**
     * Original signature :
     * <code>PIXA* pixExtractTextlines(PIX*, l_int32, l_int32, l_int32, l_int32)</code><br>
     * <i>native declaration : allheaders.h:2562</i>
     */
    Pixa pixExtractTextlines(Pix pixs, int maxw, int maxh, int minw, int minh);
...
//    int pixWriteStreamPdf(FILE fp, Pix pix, int res, String title);
     ...
     */
    void setPixMemoryManager(ILeptonica.setPixMemoryManager_allocator_callback allocator, ILeptonica.setPixMemoryManager_deallocator_callback deallocator);
...
//    int pixWriteStreamAsciiPnm(FILE fp, Pix pix);
     ...
     */
    Pix pixReadMemPnm(ByteBuffer cdata, NativeSize size);
...
//    Ptaa ptaaGetBoundaryPixels(Pix pixs, int type, int connectivity, PointerByReference pboxa, PointerByReference ppixa);
    ...
    /**
     * Original signature :
     * <code>PTAA* ptaaIndexLabelledPixels(PIX*, l_int32*)</code><br>
     * <i>native declaration : allheaders.h:3910</i>
     */
    Ptaa ptaaIndexLabelledPixels(Pix pixs, IntBuffer pncc);
...
//    Pix recogProcessToIdentify(L_Recog recog, Pix pixs, int pad);
    ...
    /**
     * Original signature :
     * <code>PIX* recogPreSplittingFilter(L_RECOG*, PIX*, l_float32, l_float32, l_int32)</code><br>
     * <i>native declaration : allheaders.h:4182</i>
     */
    Pix recogPreSplittingFilter(L_Recog recog, Pix pixs, float maxasp, float minaf, int debug);

    /**
     * Original signature :
     * <code>l_int32 recogSplittingFilter(L_RECOG*, PIX*, l_float32, l_float32, l_int32*, l_int32)</code><br>
...
//    int recogSetScaling(L_Recog recog, int scalew, int scaleh);
     ...
     */
    int recogTrainLabelled(L_Recog recog, Pix pixs, Box box, ByteBuffer text, int multflag, int debug);
...
//    int recogPadTrainingSet(PointerByReference precog, int debug);
     ...
     */
    int recogBestCorrelForPadding(L_Recog recog, L_Recoga recoga, PointerByReference pnaset, PointerByReference pnaindex, PointerByReference pnascore, PointerByReference pnasum, Pixa pixadb);
     ...
     */
    int recogCorrelAverages(L_Recog recog1, L_Recog recog2, PointerByReference pnaindex, PointerByReference pnascore, Pixa pixadb);

    /**
     * Original signature :
     * <code>l_int32 recogSetPadParams(L_RECOG*, const char*, const char*, const char*, l_int32, l_int32, l_int32, l_int32, l_int32)</code><br>
     * <i>native declaration : allheaders.h:4222</i>
     */
    int recogSetPadParams(L_Recog recog, String bootdir, String bootpattern, String bootpath, int boot_iters, int type, int min_nopad, int max_afterpad, int min_samples);
...
//     */
//    int recogaShowContent(FILE fp, L_Recoga recoga, int display);
...
//    int strcodeFinalize(PointerByReference pstrcode, String outdir);
    ...
    /**
     * Original signature :
     * <code>l_int32 l_getStructnameFromFile(const char*, char**)</code><br>

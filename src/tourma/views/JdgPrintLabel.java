...
public final class JdgPrintLabel extends javax.swing.JDialog {
    ...
    private Scene createScene() {
        ...
        Scene  scene  =  new  Scene(view, Color.ALICEBLUE);
    ...
    private void update() {
        if (!mByTeam) {
            ...
            webEngine.load(mFilename.getPath());
        ...
        try {
            ...
            for (int i = 0; i < mRound.getCoachMatchs().size(); i++) {
                ...
                for (int j = 0; j < Tournament.getTournament().getParams().getCriteriaCount(); j++) {
                    ...
                    if (prefilled) {
                        String prefilledScore = "<table>\n"
                                + "					<tr>\n"
                                + "						<td class=\"circle\">0</td>\n"
    ...
    private void initComponents() {
        ...
        getContentPane().add(jFXPanel, java.awt.BorderLayout.CENTER);

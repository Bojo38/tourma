...
public class WebCup {
    ...
    public static String getHTML() {
        ...
        for (int i = 0; i < rounds_with_cup.size(); i++) {
            ...
            sb.append("<br><CENTER>" + StringEscapeUtils.escapeHtml4(Translate.translate(bb.tourma.languages.Translate.CS_Round)) + " " + (i + 1) + "</CENTER>");
          /*  if (r.isLooserCup()) {
...
/*            if (r.isThirdPlace()) {
    ...
    static protected String getHTMLHeader() {
        ...
        if (Tournament.getTournament().getParams().isTeamTournament() && (Tournament.getTournament().getParams().getTeamPairing() == ETeamPairing.TEAM_PAIRING)) {
            sb.append("<td class=\"tab_titre\">" + StringEscapeUtils.escapeHtml4(Translate.translate(bb.tourma.languages.Translate.CS_Team)) + " 1</td>");
            ...
            sb.append("<td class=\"tab_titre\">" + StringEscapeUtils.escapeHtml4(Translate.translate(bb.tourma.languages.Translate.CS_Team)) + " 2</td>");
        } else {
            sb.append("<td class=\"tab_titre\">" + StringEscapeUtils.escapeHtml4(Translate.translate(bb.tourma.languages.Translate.CS_Coach)) + " 1</td>");
            ...
            sb.append("<td class=\"tab_titre\">" + StringEscapeUtils.escapeHtml4(Translate.translate(bb.tourma.languages.Translate.CS_Coach)) + " 2</td>");
        }

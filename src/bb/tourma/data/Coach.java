...
public final class Coach extends Competitor implements IXMLExport, Serializable {
    ...
    public void pull(Coach c) {
        ...
        for (int i = 0; i < c.getCompositionCount(); i++) {
            bb.teamma.data.Roster roster = new bb.teamma.data.Roster();
     ...
     */
    private final ArrayList<bb.teamma.data.Roster> mCompositions;
     ...
     * @return Composition
     */
    public bb.teamma.data.Roster getComposition(int i) {
     ...
     */
    public void addComposition(bb.teamma.data.Roster r) {
        mCompositions.add(r);
        updated = true;
    }
    ...
    public void setXMLElement(final Element coach) {
        try {
            ...
            while (itC.hasNext()) {
                ...
                bb.teamma.data.Roster c = new bb.teamma.data.Roster();

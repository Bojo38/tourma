...
public class Player implements Serializable {
    ...
    public void pull(Player player, LRB.E_Version version) {
        ...
        for (int i = 0; i < player.getSkillCount(); i++) {
            Skill skill = LRB.getLRB(version).getSkill(player.getSkill(i).getName(), false);
            _skills.add(skill);
        }
    }
    ...
    public int getMovement() {
        ...
        for (i = 0; i < _skills.size(); i++) {
            if (_skills.get(i).getName().equals(CS_Plus1Movement)) {
                value++;
            }
        }
        for (i = 0; i < _skills.size(); i++) {
            if (_skills.get(i).getName().equals(CS_Minus1Movement)) {
                value--;
                if (value < 1) {
                    value = 1;
                }
    ...
    public int getStrength() {
        ...
        for (i = 0; i < _skills.size(); i++) {
            if (_skills.get(i).getName().equals(CS_Plus1Strength)) {
                value++;
            }
        }
        for (i = 0; i < _skills.size(); i++) {
            if (_skills.get(i).getName().equals(CS_Minus1Strength)) {
                value--;
                if (value < 1) {
                    value = 1;
                }
    ...
    public int getAgility() {
        ...
        for (i = 0; i < _skills.size(); i++) {
            if (_skills.get(i).getName().equals(CS_Plus1Agility)) {
                value++;
            }
        }
        for (i = 0; i < _skills.size(); i++) {
            if (_skills.get(i).getName().equals(CS_Minus1Agility)) {
                value--;
                if (value < 1) {
                    value = 1;
                }
    ...
    public int getPass() {
        ...
        for (i = 0; i < _skills.size(); i++) {
            if (_skills.get(i).getName().equals(CS_Plus1Pass)) {
                value++;
            }
        }
        for (i = 0; i < _skills.size(); i++) {
            if (_skills.get(i).getName().equals(CS_Minus1Pass)) {
                value--;
                if (value < 1) {
                    value = 1;
                }
    ...
    public int getArmor() {
        ...
        for (i = 0; i < _skills.size(); i++) {
            if (_skills.get(i).getName().equals(CS_Plus1Armor)) {
                value++;
            }
        }
        for (i = 0; i < _skills.size(); i++) {
            if (_skills.get(i).getName().equals(CS_Minus1Armor)) {
                value--;
                if (value < 1) {
                    value = 1;
                }
        ...
        if (bWithSkill) {
            for (Skill s : _skills) {
                ...
                if (_version == LRB.E_Version.BB2020) {
                    if ((s.getName().equals( "Random General Skill"))
                            || (s.getName().equals( "Random Agility Skill"))
                            || (s.getName().equals( "Random Strength Skill"))
                            || (s.getName().equals("Random Pass Skill"))
                            || (s.getName().equals( "Random Mutation"))) {
                ...
                if (s.getName().equals(CS_Plus1Strength)) {
                    if (_version == LRB.E_Version.BB2020) {
                ...
                if (s.getName().equals(CS_Plus1Movement)) {
                    if (_version == LRB.E_Version.BB2020) {
                ...
                if (s.getName().equals(CS_Plus1Armor)) {
                    if (_version == LRB.E_Version.BB2020) {
                ...
                if (s.getName().equals(CS_Plus1Agility)) {
                    if (_version != LRB.E_Version.BB2020) {

                        cost += Skill._C_AGILITY_COST;
                    }
                }
                if (s.getName().equals(CS_Plus1Pass)) {
                    if (_version != LRB.E_Version.BB2020) {
                        cost += Skill._C_PASS_COST;
                    }
                }

                if (s.getName().equals(CS_Minus1Agility)) {
                    if (_version == LRB.E_Version.BB2020) {

                        cost += Skill._C_AGILITY_COST_2020;
                    }
                }
                if (s.getName().equals(CS_Minus1Pass)) {
                    if (_version == LRB.E_Version.BB2020) {

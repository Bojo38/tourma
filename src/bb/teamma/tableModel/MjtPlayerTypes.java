 ...
 */
public class MjtPlayerTypes extends AbstractTableModel implements TableCellRenderer {

    private static final Logger LOG = Logger.getLogger(MjtPlayerTypes.class.getName());
    ...
    public String getColumnName(int col) {
        switch (col) {
            case 0:
                return Translate.translate(CS_Limit);
            case 1:
...
//        int value;
        ...
        if (mPlayers.size() > 0) {
            PlayerType pt = mPlayers.get(row);
            switch (col) {
                case 0:
                    return pt.getLimit();
                case 1:

...
public class jdgRosters extends javax.swing.JDialog {
    ...
    public jdgRosters(final java.awt.Frame parent, final boolean modal) {
        ...
        for (int i = 0; i < RosterType.mRostersNames.size(); i++) {
            mModel.addElement(RosterType.mRostersNames.get(i));
        }
...
@SuppressWarnings({"PMD.UnusedFormalParameter", "PMD.MethodArgumentCouldBeFinal"})
    private void jbtOKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtOKActionPerformed
        ...
        RosterType.mRostersNames = rosters;
...
@SuppressWarnings({"PMD.UnusedFormalParameter", "PMD.MethodArgumentCouldBeFinal"})
    private void jbtAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtAddActionPerformed
       ...
       final Object name = JOptionPane.showInputDialog(this, "Nom du nouveau roster", "Nouveau roster");
        if (name != null) {

...
public class mjtAnnexRankClan extends mjtAnnexRank {
    ...
    public mjtAnnexRankClan(int round, Criteria criteria, int subtype, Vector<Clan> clans, boolean full, int ranking_type1, int ranking_type2, int ranking_type3, int ranking_type4, int ranking_type5, boolean round_only) {
